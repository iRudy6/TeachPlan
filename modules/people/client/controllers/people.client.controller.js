...
peopleApp.controller('PeopleCreateController', ['$scope', 'People', 'Notify',
  function($scope, People, Notify) {
...
peopleApp.controller('PeopleEditController', ['$scope', 'People', 'Notify','$log',
  function($scope, People, Notify,$log) {
    ...
    this.update = function(updatedPerson) {
      ...
      $log.info('Genre: '+ updatedPerson.genre);
...
peopleApp.controller('PeopleByGroupController', ['$scope', 'People', 'Groups', 'Notify','$log', '$stateParams',
  function($scope, People, Groups, Notify, $log, $stateParams) {
...
peopleApp.controller('PeopleByLessonController', ['$scope', 'People',
  ...
  $scope.init = function(studentId, status)
    {
      $scope.status = status;
    ...
    link: function(scope, element, attrs){
      //When the person status is updated
       Notify.getMsg('UpdatePersonStatus', function(event, data){
        ...
        console.log(data);
        //scope.peopleByLessonCtrl.students = Lessons.query();
